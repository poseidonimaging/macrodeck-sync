...
public class MacroDeckDataServicePortProxy implements com.macrodeck.services.dataservice_0_2.MacroDeckDataServicePort {
  private String _endpoint = null;
  private com.macrodeck.services.dataservice_0_2.MacroDeckDataServicePort macroDeckDataServicePort = null;
  ...
  private void _initMacroDeckDataServicePortProxy() {
    try {
      macroDeckDataServicePort = (new com.macrodeck.services.dataservice_0_2.MacroDeckServiceLocator()).getMacroDeckDataServicePort();
  ...
  public com.macrodeck.services.dataservice_0_2.MacroDeckDataServicePort getMacroDeckDataServicePort() {
    if (macroDeckDataServicePort == null)
      _initMacroDeckDataServicePortProxy();
  ...
  public java.lang.String createDataItem(java.lang.String authCode, java.lang.String grouping, com.macrodeck.services.dataservice_0_2.DataServiceCustomTypesItemMetadata metadata) throws java.rmi.RemoteException{
    if (macroDeckDataServicePort == null)
      _initMacroDeckDataServicePortProxy();
  ...
  public boolean setObjectValue(java.lang.String authCode, java.lang.String itemUUID, com.macrodeck.services.dataservice_0_2.DataServiceCustomTypesYAML value) throws java.rmi.RemoteException{
    if (macroDeckDataServicePort == null)
      _initMacroDeckDataServicePortProxy();
