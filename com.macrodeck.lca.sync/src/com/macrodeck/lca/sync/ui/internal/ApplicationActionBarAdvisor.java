...
public class ApplicationActionBarAdvisor extends ActionBarAdvisor {
    ...
    public IWorkbenchAction getWelcomeAction() {
        return this.welcomeAction;
    }
    
    public IWorkbenchAction getPrefsAction() {
        return this.prefsAction;
    }
    
    public IWorkbenchAction getAboutAction() {
        return this.aboutAction;
    }
    
    public IWorkbenchAction getFindAndInstallAction() {
        return this.findAndInstallAction;
    }
