...
public class MainView extends ViewPart implements IPreferencePageContainer, IPageChangeProvider {
	...
	public static final String ID = "de.mmeggs.macrodeck.lca.navigationView";
	 ...
	 */
	public static final String PREF_DLG_IMG_TITLE_ERROR = "Error...";
	 ...
	 */
	/*
	public MainView(Shell parentShell, PluginPreferenceManager manager) {
	...
	protected Control createContents(final Composite parent) {
		...
		/*BusyIndicator.showWhile(getShell().getDisplay(), new Runnable() {
			public void run() {
				control[0] = MainView.super.createContents(parent);
				// Add the first page
				selectSavedItem();
			}
		});*/
	...
	protected Composite createTitleArea(Composite parent) {
		...
		// Message label
		messageArea = new MainViewMessageArea(this);
	...
	protected Control createTreeAreaContents(Composite parent) {
		...
		treeViewer.setInput(SyncPluginManager.getInstance());
...
//	}
	...
	private Shell getShell() {
		return getPageContainer().getShell();
	}
